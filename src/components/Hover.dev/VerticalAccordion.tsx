...
import { Play, DollarSign, Bell, BarChart4 } from "lucide-react";
...
interface Item {
  id: number;
  title: string;
  Icon: React.ComponentType; // Specify that Icon is a React component
  imgSrc: string;
  description: string;
}

// Define the type for Panel component props
...
// Define the items array with the type
const items: Item[] = [
  {
    id: 1,
    title: "Earn more",
