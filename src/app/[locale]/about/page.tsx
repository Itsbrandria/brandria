...
export default function Page() {
  ...
  return (
    <main className="py-36 flex flex-col px-8 lg:px-0 gap-14 lg:gap-0 max-sm:relative">
      <section className="flex lg:px-14 flex-col gap-12 px-0">
        <div className="lg:grid lg:grid-cols-12 gap-4">
          <div className="lg:p-4 lg:col-span-1 max-sm:hidden">
            <motion.img
          ...
          <h1 className="  p-4 lg:col-span-9 overflow-hidden ">
            <SparklesText text={t("h")} sparklesCount={30} className="text-3xl  md:text-6xl line-clamp-2 !leading-relaxed ltr:!tracking-wider  !font-semibold w-full " />
          </h1>
            ...
            >
              <g id="Dodles2" transform="translate(1104.122 -135.885)">
                ...
                <motion.path
                  ...
                  initial="hidden"
                  animate="visible"
                  d="M-1061.2,222.8c-5.1-1.6-10.6-.7-15.7,1,3.5-6,4.6-13.4,2.2-19.9a18.72,18.72,0,0,0-17.8-12.2,15.97,15.97,0,0,0-11.2,4.4c-1.3,1.2.7,3.2,2,2,6-5.9,16.5-4.2,21.7,1.9,6.3,7.3,4.4,18.9-1.5,25.8-.8.9-.1,2.9,1.3,2.3,8.2-3.4,21.3-6.2,25.7,4.3,3.5,8.4-1.2,17.5-9.5,20.7a23.831,23.831,0,0,1-15.6.2c-1.7-.5-2.4,2.1-.7,2.7,9.7,3.1,22.5.7,27.6-9C-1048.1,238-1051.2,225.9-1061.2,222.8Z"
                  fill="#ff001c"
                />
                <motion.path
                  id="Path_129"
                ...
                <motion.path
                  ...
                  initial="hidden"
                  animate="visible"
                  d="M-1010.1,443.2c-3.9-1.6-8-2.2-12.1-2.9-3.8-.7-7.8-1.7-10.5-4.7-3.1-3.4-3.4-8.4-2-12.6a23.641,23.641,0,0,1,8.4-11.3c4.1-3.1,9.2-5.1,14.4-4.2,2,.3,2.9-2.8.9-3.1-10.5-1.7-20.8,5.4-25.4,14.5-2.3,4.7-3.1,10.1-1,15,1.9,4.5,5.8,7.2,10.4,8.6,5.1,1.5,10.5,1.5,15.4,3.6a1.734,1.734,0,0,0,2.2-.6A1.9,1.9,0,0,0-1010.1,443.2Z"
                  fill="#ff001c"
                />
                <motion.path
                  id="Path_133"
                  ...
                  initial="hidden"
                  animate="visible"
                  d="M-1038.2,147a67.136,67.136,0,0,0-27,26.1c-1,1.8,1.6,3.6,2.7,1.8a63.756,63.756,0,0,1,25.7-25C-1034.9,148.9-1036.3,146-1038.2,147Z"
                  fill="#ff001c"
                />
                <motion.path
                  id="Path_138"
                  ...
                  initial="hidden"
                  animate="visible"
                  d="M-1013.1,333.8a70.965,70.965,0,0,0-19.2-34.9c-1.5-1.5-3.7,1-2.2,2.4a69.02,69.02,0,0,1,18.2,33.5C-1015.7,336.9-1012.6,335.9-1013.1,333.8Z"
                  fill="#ff001c"
                />
                <motion.path
                  id="Path_140"
          ...
          <div className="p-4 col-span-1 max-sm:hidden">
            <Image
              src="/Dodles.svg"
              alt="Description of the image"
              width={100}
